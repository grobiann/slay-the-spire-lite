...
namespace STSLite.UI
{
    public static class UIRegistry
    {
        ...
        {
            { typeof(UIMainMenu), new UIInfo("Prefabs/UI/UIMainMenu", 0) },
            { typeof(UITopBar), new UIInfo("Prefabs/UI/TopBar", 10) },
            { typeof(UILogo), new UIInfo("Prefabs/UI/UILogo", 100) },
            { typeof(UIMapScreen), new UIInfo("Prefabs/UI/UIMapScreen", 100) },
            { typeof(UIBlackScreen), new UIInfo("Prefabs/UI/UIBlackScreen", 1000) },
        };
